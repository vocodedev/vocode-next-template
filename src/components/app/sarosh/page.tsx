  ...
  return (
    <main>
      ...
      <div className="flex flex-row items-center justify-center py-4">
        <Image src="/images/sarosh.png" alt="Sarosh" width={200} height={200} />
      ...
      <div className="flex flex-col items-center justify-center py-4">
        <VocodeAppDynamic defaultBackendUrl="wss://artisan-backend.artisanai.co/conversation/sarosh" isInputEditable={false} />
      </div>
      <div>
        {/* <MicWave /> */}
